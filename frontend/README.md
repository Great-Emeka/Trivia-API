...
> Only read the API Documentation to confirm your notes regarding the expected API endpoint behavior based on reading the frontend codebase.

> See the [API DOCUMENTATION](./frontend/api_documentation.md) for clarity on how to use it.
